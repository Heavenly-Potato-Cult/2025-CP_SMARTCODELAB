    // This control is originally based on RJTextBox (by RJ Code Advance)
...
namespace SmartCodeLab.CustomComponents
{
    ...
    public partial class CustomTextBox : UserControl
    {
        ...
        [Category("Custom TextBox")]
        [Description("If true, draws an underline instead of a full rectangle border.")]
        [DefaultValue(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        [Browsable(true)]
        ...
        [Category("Custom TextBox")]
        [Description("When true, masks the text as a password.")]
        [DefaultValue(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        [Browsable(true)]
        ...
        [Category("Custom TextBox")]
        [Description("Text content of the inner TextBox.")]
        [DefaultValue("")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        [Browsable(true)]
        [Bindable(true)]
